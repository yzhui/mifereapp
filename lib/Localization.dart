...
class AppLocalizations {
  ...
  static const EDIT_DISPLAY_NAME_HINT = "editDisplayNameHint";
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      TRY_UPDATE_LATER: 'Please try again after 1 minute',
      ...
      RELOAD: 'Reload',
      EDIT_DISPLAY_NAME_HINT: 'New nickname',
    },
    'zh-CN': {
      NEW_PASSWORD: '输入新的密码',
      CONFIRM_NEW_PASSWORD: '确认密码',
      CONFIRM_PASSWORD_FAIL: '密码不匹配',
      CURRENT_PASSWORD: '输入当前密码',
      RETRY_INPUT_PASSWORD: '请再次输入密码',
      CREATE_PASSWORD: '创建密码',
      CREATE_PASSWORD_BODY: '您尚示设置密码，请设置您的密码！',
      CREATE_PASSWORD_SUCCESS: '密码设置成功！',
      CREATE_PASSWORD_FAIL: '密码设置失败',
      UNLOCK_FAIL: '密码解锁失败',
      PASSWORD_CHANGED: '密码已成功更改',
      PASSWORD_UNCHANGED: '密码修改失败',
      CANCEL: '取消',
      OK: '确认',
      ADD: '添加',
      MODIFY: '修改',
      ...
      REMOVE_CATEGORY_BODY: '您确认要移除此分类吗?',
      CATEGORY_NONE: '分类名称',
      ADD_TASK: '添加任务',
      MODIFY_TASK: '修改任务',
      CHOOSE_PHOTO: '选择图片',
      SETTINGS_LOCK: '锁定屏幕',
      SETTINGS_USE_LOCK_SCREEN: '允许锁定屏幕',
      SETTINGS_RESET_PASSWORD: '重置密码',
      SETTINGS_RECOVERY_EMAIL: '恢复邮箱',
      INVALID_RECOVERY_EMAIL: '恢复邮箱无效，请重新输入！',
      SEND_TEMP_PASSWORD: '发送临时密码',
      CONFIRM_SEND_TEMP_PASSWORD: '确认发送',
      CONFIRM_SEND_TEMP_PASSWORD_BODY: '您的密码将被新的临时密码取代！',
      FAILED_TO_SAVE_TEMP_PASSWORD_BY_UNKNOWN_ERROR: '알 수 없는 오류로 임시 비밀번호 설정에 실패하였습니다',
      TEMP_PASSWORD_MAIL_SUBJECT: '[芈菲儿] 임시 비밀번호',
      ...
      SIGN_OUT: '退出登录',
      NO_PET: '펫 없음',
      NEED_UPDATE: '应用有新的版本，请更新！',
      TRY_UPDATE_LATER: '稍后更新',
      CHECK_INTERNET: '正在检查网络连接状态.',
      SIGN_OUT_TITLE: '退出登录',
      SIGN_OUT_BODY: '您确认要退出登录吗?',
      ...
      ERROR_SIGNING_IN: '登录失败！',
      ERROR_SIGNING_OUT: '退出失败！',
      NO_RANKING_USER_INFOS: '无评价数据！',
      RELOAD: '重新加载',
      EDIT_DISPLAY_NAME_HINT: '새 닉네임',
    },
  };
  ...
  String get editDisplayNameHint => _localizedValues[locale.languageCode][EDIT_DISPLAY_NAME_HINT];
